...
(() => {
              ...
              ln = (function e(t) {
                ...
                var as = Kr(function (e, t) {
                  ...
                  cs = Kr(function (e) {
                    var t = Jo(e);
                    return (
                      (t = "function" == typeof t ? t : i), di(St(e, Ks), i, t)
                    );
                  }),
                  fs = Kr(os),
                  hs = Kr(function (e) {
  ...
  (() => {
    ...
    function Q(e) {
      return (t, ...n) => {
        var r;
        if (((r = t.sender), V.has(r.id))) return e(t, ...n);
        log.error(
    ...
    function ue({
      ...
      !o &&
        "1" === process.env.GITHUB_DESKTOP_PREVIEW_FEATURES &&
        b.push({
          label: "Start pull request",
          id: "start-pull-request",
          accelerator: "CmdOrCtrl+Alt+P",
          click: ce("start-pull-request"),
        }),
        b.push({
          label: h,
    ...
    const fe = [1, 1.1, 1.25, 1.5, 1.75, 2],
      he = fe.slice().reverse();
    function de(e) {
      return (t, n) => {
        if (!n) return;
    ...
    async function We(e, t, n) {
      ...
      if (
        ...
        r.set("sha", "7cd667172c2eb688e24e26cdfbf9f367ef278429"),
    ...
    function Je(e, t, n = []) {
      ...
      for (const [o, s] of e.entries())
        if (Ke(s.role, "editmenu")) for (const e of Ve()) r.append(e);
        else {
          const e = [...n, o];
          r.append(
            new i.MenuItem({
