...
(() => {
  var e = {
      ...
      7931: (e, t, r) => {
        ...
        (t.default = (0, c.default)(function (e, t, r) {
          return ((0, n.default)(e) ? d : h)(e, (0, l.default)(t), r);
        }, 3)),
          (e.exports = t.default);
      },
      9622: (e, t, r) => {
          ...
          function m(e, t) {
            if (!h)
              if (((f -= 1), e)) (d = !0), c(e);
                ...
                if (t === l.default || (d && f <= 0)) return (d = !0), c(null);
                p || g();
              }
          }
          function g() {
            for (p = !0; f < e && !d; ) {
              var t = u();
              if (null === t) return (d = !0), void (f <= 0 && c(null));
              (f += 1), r(t.value, t.key, (0, i.default)(m));
            }
            p = !1;
          }
          g();
      ...
      7196: (e, t, r) => {
        ...
        const g = function (e, t, r) {
            ...
            if (null == i || null == s) {
              ...
              null == i && (i = h = [1 | t[0], t[1], t[2], t[3], t[4], t[5]]),
      ...
      8734: (e, t, r) => {
        ...
        (e.exports = (e, t, r) => {
          ...
          n.opts.timeout > 0 &&
            (b = setTimeout(() => {
              (b = null), (_ = !0), f.kill(n.opts.killSignal);
            }, n.opts.timeout));
          ...
          const O = () =>
            u(
              Promise.all([
                S,
                v(f, "stdout", { encoding: s, buffer: a, maxBuffer: c }),
                v(f, "stderr", { encoding: s, buffer: a, maxBuffer: c }),
              ]).then((e) => {
                const t = e[0];
                if (
                  ((t.stdout = e[1]),
                  ...
                  const e = y(t, { joinedCmd: h, parsed: n, timedOut: _ });
                  if (((e.killed = e.killed || f.killed), !n.opts.reject))
                    return e;
                  throw e;
                }
                return {
          ...
          return (
            i._enoent.hookChildProcess(f, n.parsed),
            (function (e, t) {
              null != t && (l(t) ? t.pipe(e.stdin) : e.stdin.end(t));
            })(f, n.opts.input),
            (f.then = (e, t) => O().then(e, t)),
            (f.catch = (e) => O().catch(e)),
            f
          );
        }),
      ...
      1260: (e, t, r) => {
        ...
        function A(e, t, r) {
          ...
          if (!h) return null;
          for (var f = u(u({}, m), r), p = 1; p < h.length; p++) {
            var g = i[p - 1],
              y = g[0],
              w = g[2],
              b = w ? w(h[p], f) : +h[p];
      ...
      4079: (e, t, r) => {
          ...
          if (null === t)
            ...
            if (
              ...
              (c.reading = !1),
                c.decoder && !r
                  ? ((t = c.decoder.write(t)),
                    c.objectMode || 0 !== t.length ? C(e, c, t, !1) : j(e, c))
                  : C(e, c, t, !1);
            }
        ...
        (x.prototype.read = function (e) {
          ...
          (x.prototype.pipe = function (e, t) {
            ...
            function f() {
              o("onfinish"), e.removeListener("close", h), p();
            }
            function p() {
              o("unpipe"), r.unpipe(e);
            }
      ...
      3105: (e, t, r) => {
        ...
        function p(e) {
          ...
          if (null !== t) {
            var r = e[h].read();
            null !== r &&
              ((e[u] = null), (e[s] = null), (e[a] = null), t(f(r, !1)));
          }
        }
        function m(e) {
        ...
        e.exports = function (e) {
            ...
            r = Object.create(
              ...
              o(t, d, {
                value: function (e, t) {
                  var n = r[h].read();
                  n
                    ? ((r[u] = null), (r[s] = null), (r[a] = null), e(f(n, !1)))
                    : ((r[s] = e), (r[a] = t));
                },
                writable: !0,
              }),
          ...
          return (
            ...
            i(e, function (e) {
              ...
              var n = r[s];
              null !== n &&
                ((r[u] = null), (r[s] = null), (r[a] = null), n(f(void 0, !0))),
                (r[c] = !0);
            }),
            ...
            switch (
              ...
              case "object": {
                ...
                if (Array.isArray(v)) {
                  ...
                  let n = 0;
                  for (; n < t - 1; n++) {
                    const t = s(n, v, h, f, m, g);
                    (e += void 0 !== t ? t : "null"), (e += r);
                  }
                  const a = s(n, v, h, f, m, g);
                  return (
                    (e += void 0 !== a ? a : "null"),
                    v.length - 1 > i &&
            ...
            switch (
              ...
              case "object": {
                ...
                if (Array.isArray(n)) {
                  ...
                  const f = c(a, n[a], s, l, u, d);
                  return (
                    (r += void 0 !== f ? f : "null"),
                    n.length - 1 > i &&
                      (r += `${h}"... ${p(n.length - i - 1)} not stringified"`),
                    "" !== u && (r += `\n${e}`),
                    s.pop(),
                    `[${r}]`
                  );
            ...
            switch (typeof s) {
              ...
              case "object": {
                ...
                if (Array.isArray(s)) {
                  ...
                  let a = 0;
                  for (; a < n - 1; a++) {
                    const r = g(a, s[a], c, h, f);
                    (e += void 0 !== r ? r : "null"), (e += t);
                  }
                  const l = g(a, s[a], c, h, f);
                  return (
                    (e += void 0 !== l ? l : "null"),
                    s.length - 1 > i &&
      ...
      7891: (e, t) => {
        ...
        function ue(e, t, r, n, o, i, s, a, l, c, u, d, h) {
          return (
            (t = ce(r)
              ? ""
              : ce(n)
        ...
        (se.prototype.parse = function (e) {
          var t = this.options.loose ? i[H] : i[B],
            r = e.match(t);
          ...
          (se.prototype.intersects = function (e, t) {
            ...
            if (
              ...
              return (r = new le(e.value, t)), he(this.value, r, t);
            if ("" === e.operator)
              return (r = new le(this.value, t)), he(e.semver, r, t);
            var n = !(
                (">=" !== this.operator && ">" !== this.operator) ||
      ...
      4047: (e, t, r) => {
        ...
        (a.fromStringWithSourceMap = function (e, t, r) {
          ...
          return (
            ...
            l < s.length && (h && f(h, c()), n.add(s.splice(l).join(""))),
      ...
      9891: (e, t, r) => {
        ...
        function a(e, t, r) {
          ...
          var a = s(e, t),
            ...
            d = [];
          !(function s(a, h) {
            if (a === h) return t.all && d.length ? r(null, d) : r(i(e));
            var f = l[a];
            '"' === f.charAt(0) && '"' === f.slice(-1) && (f = f.slice(1, -1));
            var p = n.join(f, e);
            !f && /^\.[\\\/]/.test(e) && (p = e.slice(0, 2) + p),
              (function e(n, i) {
                if (n === i) return s(a + 1, h);
                var l = c[n];
  ...
  (() => {
    ...
    class f extends u() {
      log(e, t) {
        setImmediate(() => this.emit("logged", e));
        const r = h[e[d.LEVEL]] ?? console.log;
        try {
          r(e[d.MESSAGE]);
        } catch {}
        t?.();
    ...
    var A = r(9764);
    const k = require("url"),
      j = ["renderer.js", "main.js"];
    function T(e) {
      if (!j.some((t) => e.endsWith(t))) return null;
    ...
    z("select-all-window-contents", 0),
      z("update-menu-state", 1),
      z("renderer-ready", 1),
      z("execute-menu-item-by-id", 1),
      q("is-window-focused", 0),
      z("focus-window", 0),
      q("show-item-in-folder", 1),
      z("unsafe-open-directory", 1),
      q("open-external", 1),
      q("move-to-trash", 1),
      q("get-current-window-state", 0),
      q("get-current-window-zoom-factor", 0),
      z("dialog-did-open", 0),
      z("set-window-zoom-factor", 1),
      q("check-for-updates", 1),
      z("quit-and-install-updates", 0),
      z("quit-app", 0),
      z("set-native-theme-source", 1),
      q("should-use-dark-colors", 0),
      z("minimize-window", 0),
      z("maximize-window", 0),
      z("unmaximize-window", 0),
      z("close-window", 0),
      q("is-window-maximized", 0),
      q("get-apple-action-on-double-click", 0),
      z("show-certificate-trust-dialog", 2),
      q("get-path", 1),
      q("get-app-architecture", 0),
      q("get-app-path", 0),
      q("is-running-under-arm64-translation", 0),
      q("move-to-applications-folder", 0),
      z("get-app-menu", 0),
      q("show-contextual-menu", 2),
      z("update-preferred-app-menu-item-labels", 1),
      z("uncaught-exception", 1),
      z("send-error-report", 3),
      z("update-accounts", 1),
      q("resolve-proxy", 1),
      q("is-in-application-folder", 0),
      q("show-save-dialog", 1),
      q("show-open-dialog", 1),
      q("save-guid", 1),
      q("get-guid", 0),
      q("show-notification", 3),
      q("get-notifications-permission", 0),
      q("request-notifications-permission", 0),
      z("install-windows-cli", 0),
      z("uninstall-windows-cli", 0),
      o.shell.beep,
      o.shell.openPath;
    var G = r(1391);
    function W(e, t, ...r) {
    ...
    function V(e) {
      e.on("enter-full-screen", () => K(e, "full-screen")),
        e.on("leave-full-screen", () => K(e, "normal")),
        e.on("maximize", () => K(e, "maximized")),
        e.on("minimize", () => K(e, "minimized")),
        e.on("unmaximize", () => K(e, "normal")),
        e.on("restore", () => K(e, "normal")),
        e.on("hide", () => K(e, "hidden")),
        e.on("show", () => {
          K(e, Y(e));
        });
    }
    function K(e, t) {
      W(e.webContents, "window-state-changed", t);
    }
    function Z(e) {
      throw new Error(e);
    }
    ...
    function X(e, t) {
      return { id: t, type: "menu", items: e.items.map(J) };
    }
    function Q() {
    ...
    const re = new Set(),
      ne = (e) => {
        re.add(e.id), e.on("destroyed", () => re.delete(e.id));
      };
    function oe(e, t) {
      o.ipcMain.on(e, se(t));
    }
    function ie(e, t) {
      o.ipcMain.handle(e, se(t));
    }
    function se(e) {
      return (t, ...r) => {
        var n;
        if (((n = t.sender), re.has(n.id))) return e(t, ...r);
        log.error(
    ...
    function pe() {
      return he()({ random: fe(16) });
    }
    let me;
    const ge = () => (0, t.join)(o.app.getPath("userData"), ".update-id"),
      ve = (e) => (0, g.writeFile)(ge(), e).then(() => e);
    class ye {
      window;
      emitter = new G.Emitter();
      _loadTime = null;
      ...
      constructor() {
        ...
        (this.window = new o.BrowserWindow(t)),
          ...
          (function (e) {
            (0, ae.V2)((t, r, n) => {
              W(e.webContents, "notification-event", t, r, n);
            });
          })(this.window),
        ...
        o.app.on("before-quit", () => {
          ...
          this.window.on("close", (e) => {
            if (!n && this.isDownloadingUpdate)
              return (
                e.preventDefault(),
                W(this.window.webContents, "show-installing-update"),
                void this.show()
              );
      ...
      load() {
        ...
        this.window.webContents.once("did-start-loading", () => {
          (this._rendererReadyTime = null), (this._loadTime = null), (e = Q());
        }),
          this.window.webContents.once("did-finish-load", () => {
            (this._loadTime = Q() - e), this.maybeEmitDidLoad();
          }),
          ...
          o.ipcMain.once("renderer-ready", se(r)),
          this.window.on("focus", () => W(this.window.webContents, "focus")),
          this.window.on("blur", () => W(this.window.webContents, "blur")),
          V(this.window),
          this.window.loadURL(
          ...
          o.nativeTheme.addListener("updated", (e, t) => {
            W(this.window.webContents, "native-theme-updated");
          }),
      ...
      sendMenuEvent(e) {
        this.show(), W(this.window.webContents, "menu-event", e);
      }
      sendURLAction(e) {
        this.show(), W(this.window.webContents, "url-action", e);
      }
      sendLaunchTimingStats(e) {
        W(this.window.webContents, "launch-timing-stats", e);
      }
      sendAppMenu() {
        const e = o.Menu.getApplicationMenu();
        if (e) {
          const t = X(e);
          W(this.window.webContents, "app-menu", t);
        }
      }
      dialogDidOpen() {
      ...
      sendCertificateError(e, t, r) {
        W(this.window.webContents, "certificate-error", e, t, r);
      }
      ...
      setupAutoUpdater() {
        o.autoUpdater.on("error", (e) => {
          (this.isDownloadingUpdate = !1),
            W(this.window.webContents, "auto-updater-error", e);
        }),
          o.autoUpdater.on("checking-for-update", () => {
            (this.isDownloadingUpdate = !1),
              W(this.window.webContents, "auto-updater-checking-for-update");
          }),
          o.autoUpdater.on("update-available", () => {
            (this.isDownloadingUpdate = !0),
              W(this.window.webContents, "auto-updater-update-available");
          }),
          o.autoUpdater.on("update-not-available", () => {
            (this.isDownloadingUpdate = !1),
              W(this.window.webContents, "auto-updater-update-not-available");
          }),
          o.autoUpdater.on("update-downloaded", () => {
            (this.isDownloadingUpdate = !1),
              W(this.window.webContents, "auto-updater-update-downloaded");
          });
      }
      async checkForUpdates(e) {
        try {
          o.autoUpdater.setFeedURL({ url: await we(e) }),
    ...
    const we = async (e) => {
      try {
        const t = await (async () =>
          me ??
          (0, g.readFile)(ge(), "utf8")
            .then((e) => e.trim())
            .then((e) => (36 === e.length ? e : ve(pe())))
            .catch(() => ve(pe()))
            .catch((e) => {
    ...
    function _e(e, t = "@", r = new Set()) {
      for (const n of e) {
        ...
        (n.id = o), r.add(o), n.submenu && _e(n.submenu, n.id, r);
      }
    }
    function Ee(e) {
    ...
    function xe({
        ...
        f.push({
          ...
          submenu: [
            ...
            },
            {
              ...
              accelerator: "Ctrl+H",
              click: Ce(c ? "hide-stashed-changes" : "show-stashed-changes"),
            },
            ...
            { label: "放大", accelerator: "CmdOrCtrl+=", click: Ae(Se.In) },
            {
              label: "缩小",
              accelerator: "CmdOrCtrl+-",
              click: Ae(Se.Out),
      ...
      w.push({
        ...
        f.push({ label: "&分支", id: "branch", submenu: w });
      const b = [
        {
          label: "报告问题…",
          click() {
    ...
    function Ce(e) {
      return (t, r) => {
        ...
        void 0 !== n && W(n.webContents, "menu-event", e);
      };
    }
    !(function (e) {
      (e[(e.Reset = 0)] = "Reset"),
    ...
    const Re = [0.67, 0.75, 0.8, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2],
      Me = Re.slice().reverse();
    function Ae(e) {
      return (t, r) => {
        if (!r) return;
        const { webContents: n } = r;
        if (e === Se.Reset) (n.zoomFactor = 1), W(n, "zoom-factor-changed", 1);
        else {
          const t = n.zoomFactor,
            ...
            s = r.find((t) => (e === Se.In ? t > i : t < i)),
            a = void 0 === s ? i : s;
          (n.zoomFactor = a), W(n, "zoom-factor-changed", a);
        }
        var o;
      };
    }
    ...
    const Ne = m(() => !1),
      Pe =
        ...
        m(() =>
          (function (e) {
            const t = Le();
            return void 0 !== t && (0, Te.compare)(t, "10.0.17666", ">=");
          })()
        ),
        m(() =>
          (function (e) {
            const t = Le();
            return void 0 !== t && (0, Te.compare)(t, "10", "<");
          })()
        )),
      De = m(() => !1);
    m(() => De() || Pe()), new Set(["LOCAL_GIT_DIRECTORY"]);
    ...
    var Fe = r(6969);
    function Ue() {
      for (const t of (0, Fe.enumerateValues)(
        Fe.HKEY.HKEY_CURRENT_USER,
        "Environment"
      ))
        if (
          "Path" === t.name &&
          ((e = t).type === Fe.RegistryValueType.REG_SZ ||
            e.type === Fe.RegistryValueType.REG_EXPAND_SZ)
        )
          return t;
      var e;
      return null;
    ...
    async function rt() {
      if (!tt) {
        let e = await (async function () {
          let e;
          try {
            (e = (await (0, g.readFile)(ot(), "utf8")).trim()),
    ...
    async function nt(e) {
      (tt = e), await (0, g.writeFile)(ot(), e, "utf8");
    }
    const ot = () => (0, t.join)(o.app.getPath("userData"), ".guid");
    let it = !1;
    async function st(e, t, r) {
      ...
      if (
        ...
        n.set("architecture", Qe(o.app)),
        n.set("sha", "27793d9355d64fa0b1a5c31c9901e59db93f27f8"),
    ...
    class at {
      ...
      sendError() {
        ...
        W(this.window.webContents, "error", t);
      }
      destroy() {
        this.window.destroy();
      }
    ...
    function ut() {
      ...
      return (e && e.submenu ? e.submenu.items : []).filter(
        (e) => !ct(e.role, "pasteandmatchstyle")
      );
    }
    function dt(e, t, r) {
      const n = ht(e, t);
    ...
    function ht(e, t, r = []) {
      ...
      for (const [i, s] of e.entries())
        if (ct(s.role, "editmenu")) for (const e of ut()) n.append(e);
        else {
          const e = [...r, i];
          n.append(
            new o.MenuItem({
              ...
              role: s.role,
              click: () => t(e),
              submenu: s.submenu ? ht(s.submenu, t, e) : void 0,
            })
          );
        }
      return n;
    ...
    class mt {
      ...
      onSendHeaders;
      constructor(e) {
        (this.onBeforeRedirect = new ft(e.onBeforeRedirect.bind(e))),
          (this.onBeforeRequest = new pt(
          ...
          (this.onBeforeSendHeaders = new pt(
          ...
          (this.onCompleted = new ft(e.onCompleted.bind(e))),
          (this.onErrorOccurred = new ft(e.onErrorOccurred.bind(e))),
          (this.onHeadersReceived = new pt(
          ...
          (this.onResponseStarted = new ft(e.onResponseStarted.bind(e))),
          (this.onSendHeaders = new ft(e.onSendHeaders.bind(e)));
      }
    }
    const gt = (e) =>
    ...
    var yt, wt;
    Error,
      ((wt = yt || (yt = {}))[(wt.Sms = 0)] = "Sms"),
      (wt[(wt.App = 1)] = "App"),
      r(4515);
    var bt = r(7891);
    const _t = new bt.SemVer("3.1.0"),
      Et = (new Map(), new Map()),
      St = (e) => {
        if (e === $t()) return !0;
      ...
      xt = (e) => new URL(e).hostname.endsWith(".ghe.com");
    function Ot(e) {
      const t = `endpoint-version:${e}`,
        r = Et.get(t);
      if (void 0 !== r) return r;
      const n = localStorage.getItem(t),
        o = null === n ? null : bt.parse(n);
    ...
    function Ct(e, t, r) {
      return (
        ...
        (!0 === e
          ? t
          : (null == r && Z("Need to provide a version to compare against"),
            t && bt.satisfies(r, e)))
      );
    }
    const Rt =
        ({ dotcom: e, ghe: t, es: r }, n = Ot) =>
        (o) =>
          Ct(e, St(o)) ||
          Ct(t ?? e, xt(o)) ||
          Ct(r, ((e) => !St(e) && !xt(e))(o), n(o) ?? _t),
      Mt =
        (Rt({ es: ">= 3.0.0" }),
      ...
      kt = process.env.DESKTOP_GITHUB_DOTCOM_ADDITIONAL_COOKIES;
    void 0 !== kt && (document.cookie += "; " + kt);
    var jt, Tt, Lt, Nt, Pt, Dt;
    function $t() {
    ...
    function Gt(e) {
      Bt = !0;
      const t = null === Ut;
      Ut && (Ut.destroy(), (Ut = null)),
        (function (e, t) {
          if ((log.error(I(t)), lt)) return;
          (lt = !0),
            (function () {
              const e = o.Menu.getApplicationMenu();
              if (e) for (const t of e.items) ke(t);
            })();
    ...
    function Wt() {
      return {
        uptime: ((Q() - Ht) / 1e3).toFixed(3),
        time: new Date().toString(),
      };
    }
    const Yt = "--protocol-launcher",
      Vt = new Set(["x-github-client"]);
              ...
              return (async function () {
                await (async function () {
                  ...
                  if (e) {
                    ...
                    return Xe(
                      (await ((r = n), (0, g.access)(r).then(B()(!0), B()(!1))))
                        ? ["StartMenu", "Desktop"]
                        : ["StartMenu"]
                    );
                  }
    ...
    void 0 === ce &&
      ...
      void 0 === ce &&
        ...
        (ce = "{27D44D0C-A542-5B90-BCDB-AC3126048BA2}")),
      log.info(`Using toast activator CLSID ${ce}`),
      (0, ae._R)({ toastActivatorClsid: ce }));
    let Jt = !1;
    if (!Kt) {
    ...
    (function (e) {
      ...
      o.app.on("ready", () => {
        ...
        (qt = Q() - Ht),
          Vt.forEach((e) =>
            (function (e) {
              o.app.setAsDefaultProtocolClient(e, process.execPath, [Yt]);
            })(e)
          ),
          (function () {
            const e = new ye();
            e.onClosed(() => {
              (Ut = null), Bt || o.app.quit();
            }),
              e.onDidLoad(() => {
                e.show(),
        ...
        const e = new mt(o.session.defaultSession.webRequest);
        !(function (e) {
          const t = new Map(),
          ...
          (function (e) {
            e.onBeforeSendHeaders.addEventListener(async (e) => {
              ...
              return "wss:" !== t
                ? {}
                : /^alive\.github\.com$/.test(r) ||
                  /^alive\.(.*)\.ghe\.com$/.test(r)
                ? {
                    requestHeaders: {
                      ...e.requestHeaders,
        ...
        o.Menu.setApplicationMenu(
          ...
          oe("update-preferred-app-menu-item-labels", (e, t) => {
            ...
            i && Ut && (o.Menu.setApplicationMenu(r), Ut.sendAppMenu());
          }),
          ...
          oe("update-menu-state", (e, t) => {
            ...
            if (null !== n) {
              ...
              r && Ut && (o.Menu.setApplicationMenu(n), Ut.sendAppMenu());
          ...
          ie("check-for-updates", async (e, t) => Ut?.checkForUpdates(t)),
          oe("quit-and-install-updates", () => Ut?.quitAndInstallUpdate()),
          oe("quit-app", () => o.app.quit()),
          oe("minimize-window", () => Ut?.minimizeWindow()),
          oe("maximize-window", () => Ut?.maximizeWindow()),
          oe("unmaximize-window", () => Ut?.unmaximizeWindow()),
          oe("close-window", () => Ut?.closeWindow()),
          ie("is-window-maximized", async () => Ut?.isMaximized() ?? !1),
          ...
          ie("get-current-window-state", async () =>
            Ut?.getCurrentWindowState()
          ),
          ie("get-current-window-zoom-factor", async () =>
            Ut?.getCurrentWindowZoomFactor()
          ),
          oe("set-window-zoom-factor", (e, t) => Ut?.setWindowZoomFactor(t)),
          oe("install-windows-cli", Ye),
          oe("uninstall-windows-cli", Ve),
          oe("get-app-menu", () => Ut?.sendAppMenu()),
          oe("show-certificate-trust-dialog", (e, t, r) => {
            Qt((e) => {
              e.showCertificateTrustDialog(t, r);
            });
          }),
          oe("log", (e, t, r) => M(t, r)),
          oe("uncaught-exception", (e, t) => Gt(t)),
          oe("send-error-report", (e, t, r, n) => {
            st(t, { ...Wt(), ...r }, n);
          }),
          ...
          ie("get-path", async (e, t) => o.app.getPath(t)),
          ie("get-app-architecture", async () => Qe(o.app)),
          ie("get-app-path", async () => o.app.getAppPath()),
          ie("is-running-under-arm64-translation", async () => et(o.app)),
          ie("move-to-applications-folder", async () => {
            o.app.moveToApplicationsFolder?.();
          }),
          ie("move-to-trash", (e, t) => o.shell.trashItem(t)),
          ie("show-item-in-folder", async (e, t) =>
            o.shell.showItemInFolder(t)
          ),
          oe("unsafe-open-directory", async (e, t) => Ee(t)),
          oe("select-all-window-contents", () => Ut?.selectAllWindowContents()),
          oe("dialog-did-open", () => Ut?.dialogDidOpen()),
          ie(
          ...
          ie("show-save-dialog", async (e, t) => Ut?.showSaveDialog(t) ?? null),
          ie("show-open-dialog", async (e, t) => Ut?.showOpenDialog(t) ?? null),
          ie("is-window-focused", async () => Ut?.isFocused() ?? !1),
          oe("focus-window", () => {
            Ut?.focus();
          }),
          ...
          ie("get-guid", () => rt()),
          ie("save-guid", (e, t) => nt(t)),
          ie("show-notification", async (e, t, r, n) => (0, ae.c0)(t, r, n)),
          ie("get-notifications-permission", async () => (0, ae.X)()),
          ie("request-notifications-permission", async () => (0, ae.QJ)());
      }),
      o.app.on("activate", () => {
        Qt((e) => {
          e.show();
