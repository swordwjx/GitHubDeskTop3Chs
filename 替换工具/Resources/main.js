...
(() => {
  ...
  (() => {
    ...
    class w extends l() {
      ...
      async log(e, t) {
        ...
        (void 0 !== this.stream && this.stream.path === n) ||
          (this.stream?.end(),
          (this.stream = (0, m.createWriteStream)(n, {
            flags: "a",
          })),
    ...
    function be() {
      for (const t of (0, ye.enumerateValues)(
        ye.HKEY.HKEY_CURRENT_USER,
        "Environment"
      ))
        if (
          "Path" === t.name &&
          ((e = t).type === ye.RegistryValueType.REG_SZ ||
            e.type === ye.RegistryValueType.REG_EXPAND_SZ)
        )
    ...
    async function $e() {
      if (!Ie) {
        let e = await (async function () {
          let e;
          try {
            (e = (await (0, g.readFile)(Ue(), "utf8")).trim()),
    ...
    async function He(e, t, n) {
      ...
      if (
        ...
        r.set("architecture", Le(i.app)),
        r.set("sha", "25b66588c96606a1e39de3a38c2c2289328385e0"),
    ...
    function Ge() {
      ...
      return (e && e.submenu ? e.submenu.items : []).filter(
        (e) => !We(e.role, "pasteandmatchstyle")
      );
    }
    ...
    function Ke(e, t, n = []) {
      ...
      for (const [o, s] of e.entries())
        if (We(s.role, "editmenu")) for (const e of Ge()) r.append(e);
        else {
          const e = [...n, o];
          r.append(
            new i.MenuItem({
    ...
    class Je {
      ...
      onSendHeaders;
      constructor(e) {
        (this.onBeforeRedirect = new Ve(e.onBeforeRedirect.bind(e))),
          (this.onBeforeRequest = new Ze(
          ...
          (this.onBeforeSendHeaders = new Ze(
          ...
          (this.onCompleted = new Ve(e.onCompleted.bind(e))),
          (this.onErrorOccurred = new Ve(e.onErrorOccurred.bind(e))),
          (this.onHeadersReceived = new Ze(
          ...
          (this.onResponseStarted = new Ve(e.onResponseStarted.bind(e))),
          (this.onSendHeaders = new Ve(e.onSendHeaders.bind(e)));
      }
    }
    const Xe = (e) =>
    ...
    const et = "Set spellcheck to English",
      ...
      nt && (nt.destroy(), (nt = null)),
        (function (e, t) {
          ...
          (qe = !0),
            (function () {
              const e = i.Menu.getApplicationMenu();
              if (e) for (const t of e.items) fe(t);
            })();
    ...
    function ut() {
      return {
        uptime: ((G() - rt) / 1e3).toFixed(3),
        time: new Date().toString(),
      };
    }
    const lt = "--protocol-launcher",
      ct = new Set(["x-github-client"]);
    ct.add("x-github-desktop-auth"),
      ct.add("github-windows"),
    ...
    void 0 === Q &&
      ...
      void 0 === Q &&
        ...
        (Q = "{27D44D0C-A542-5B90-BCDB-AC3126048BA2}")),
      log.info(`Using toast activator CLSID ${Q}`),
      (0, J._R)({
    ...
    if (!ft) {
      ...
      (dt = !e),
        i.app.on("second-instance", (e, t, n) => {
          nt &&
            (nt.isMinimized() && nt.restore(),
            nt.isVisible() || nt.show(),
            nt.focus()),
            pt(t);
        }),
        dt && i.app.quit();
    ...
    function pt(e) {
      log.info(`Received possible protocol arguments: ${e.length}`);
      {
        const t = e.filter((e) => {
          try {
            const t = M.parse(e);
            return t.protocol && ct.has(t.protocol.slice(0, -1));
          } catch (t) {
    ...
    (function (e) {
      ...
      i.app.on("ready", () => {
        ...
        i.Menu.setApplicationMenu(
          ...
          V("update-accounts", (e, n) => t(n)),
          V("update-preferred-app-menu-item-labels", (e, t) => {
            const n = oe(t),
              r = i.Menu.getApplicationMenu();
            if (null === r)
              return (
                i.Menu.setApplicationMenu(n),
                void (null !== nt && nt.sendAppMenu())
              );
            let o = !1;
            for (const e of he(n)) {
              const t = e.id;
            ...
            o && nt && (i.Menu.setApplicationMenu(n), nt.sendAppMenu());
          }),
          ...
          V("update-menu-state", (e, t) => {
            ...
            if (null !== r) {
              ...
              n && nt && (i.Menu.setApplicationMenu(r), nt.sendAppMenu());
          ...
          Z("check-for-updates", async (e, t) => nt?.checkForUpdates(t)),
          V("quit-and-install-updates", () => nt?.quitAndInstallUpdate()),
          V("minimize-window", () => nt?.minimizeWindow()),
          V("maximize-window", () => nt?.maximizeWindow()),
          V("unmaximize-window", () => nt?.unmaximizeWindow()),
          V("close-window", () => nt?.closeWindow()),
          Z("is-window-maximized", async () => nt?.isMaximized() ?? !1),
          Z("get-apple-action-on-double-click", async () =>
            i.systemPreferences.getUserDefault(
              "AppleActionOnDoubleClick",
              "string"
            )
          ),
          Z("get-current-window-state", async () =>
            nt?.getCurrentWindowState()
          ),
          Z("get-current-window-zoom-factor", async () =>
            nt?.getCurrentWindowZoomFactor()
          ),
          V("set-window-zoom-factor", (e, t) => nt?.setWindowZoomFactor(t)),
          V("get-app-menu", () => nt?.sendAppMenu()),
          V("show-certificate-trust-dialog", (e, t, n) => {
            gt((e) => {
              e.showCertificateTrustDialog(t, n);
            });
          }),
          V("log", (e, t, n) => C(t, n)),
          V("uncaught-exception", (e, t) => at(t)),
          V("send-error-report", (e, t, n, r) => {
            He(
              t,
              {
                ...ut(),
          ...
          Z("get-path", async (e, t) => i.app.getPath(t)),
          Z("get-app-architecture", async () => Le(i.app)),
          Z("get-app-path", async () => i.app.getAppPath()),
          Z("is-running-under-arm64-translation", async () => je(i.app)),
          Z("move-to-applications-folder", async () => {
            i.app.moveToApplicationsFolder?.();
          }),
          Z("move-to-trash", (e, t) => i.shell.trashItem(t)),
          Z("show-item-in-folder", async (e, t) => i.shell.showItemInFolder(t)),
          V("unsafe-open-directory", async (e, t) => re(t)),
          V("select-all-window-contents", () => nt?.selectAllWindowContents()),
          Z(
            "is-in-application-folder",
            async () => i.app.isInApplicationsFolder?.() ?? null
          ),
          Z("resolve-proxy", async (e, t) =>
            i.session.defaultSession.resolveProxy(t)
          ),
          Z("show-save-dialog", async (e, t) => nt?.showSaveDialog(t) ?? null),
          Z("show-open-dialog", async (e, t) => nt?.showOpenDialog(t) ?? null),
          Z("is-window-focused", async () => nt?.isFocused() ?? !1),
          V("focus-window", () => {
            nt?.focus();
          }),
          ...
          Z("get-guid", () => $e()),
          Z("save-guid", (e, t) => Fe(t)),
          Z("show-notification", async (e, t, n, r) => (0, J.c0)(t, n, r)),
          Z("get-notifications-permission", async () => (0, J.X)()),
          Z("request-notifications-permission", async () => (0, J.QJ)());
      }),
      i.app.on("activate", () => {
        gt((e) => {
          e.show();
