...
(() => {
  var e = {
          ...
          return (function (e, t) {
            ...
            (e = e.split(""))))
              if (!i(s)) {
                ...
                var l = ["up", "mid", "down"];
                for (var u in l)
                  for (var c = l[u], d = 0; d <= n[c]; d++)
                    t[c] && (a += r[c][o(r[c].length)]);
              }
            return a;
          })(e, t);
        };
          ...
          function m(e, t) {
            if (!f)
              if (((h -= 1), e)) (d = !0), u(e);
                ...
                if (t === l.default || (d && h <= 0)) return (d = !0), u(null);
                p || g();
              }
          }
          function g() {
            for (p = !0; h < e && !d; ) {
              var t = c();
              if (null === t) return (d = !0), void (h <= 0 && u(null));
      ...
      7196: (e, t, r) => {
        ...
        const g = function (e, t, r) {
            ...
            (p = l), (m = u), (h = s), (l += 122192928e5);
            const g = (1e4 * (268435455 & l) + u) % 4294967296;
            (o[n++] = (g >>> 24) & 255),
              (o[n++] = (g >>> 16) & 255),
              (o[n++] = (g >>> 8) & 255),
              (o[n++] = 255 & g);
      ...
      2382: (e, t, r) => {
        ...
        e.exports = function (e) {
          ...
          function g() {
            clearTimeout(u), (u = setTimeout(p, 100));
          }
          function v() {
            p();
          }
        ...
        var n = r(3417),
          ...
          i = function (e, t, r) {
            ...
            var s = e._writableState,
              ...
              m = function () {
                return (!l || (a && a.ended)) && (!u || (s && s.ended))
                  ? void 0
      ...
      8734: (e, t, r) => {
        ...
        function v(e, t, { encoding: r, buffer: n, maxBuffer: o }) {
          ...
          return (
            (i = n
              ? r
                ? u(e[t], { encoding: r, maxBuffer: o })
                : u.buffer(e[t], { maxBuffer: o })
              : new Promise((r, n) => {
        ...
        (e.exports = (e, t, r) => {
          const n = p(e, t, r),
            { encoding: s, buffer: a, maxBuffer: u } = n.opts,
            f = w(e, t);
          let h, g;
          try {
          ...
          const O = () =>
            c(
              Promise.all([
                S,
                v(h, "stdout", { encoding: s, buffer: a, maxBuffer: u }),
                v(h, "stderr", { encoding: s, buffer: a, maxBuffer: u }),
              ]).then((e) => {
                const t = e[0];
                if (
                  ((t.stdout = e[1]),
      ...
      1260: (e, t, r) => {
        ...
        function A(e, t, r) {
          ...
          (l = v(l).replace(n, function (e) {
            ...
            return (u[r] = !0), o && (d[o] = !0), i.push(t), "(" + n + ")";
          })),
          ...
          if (!f) return null;
          for (var h = c(c({}, m), r), p = 1; p < f.length; p++) {
            var g = i[p - 1],
              y = g[0],
              w = g[2],
              b = w ? w(f[p], h) : +f[p];
        ...
        class a {
          ...
          _splat(e, t) {
            const r = e.message,
              ...
              d = c.length;
            if (d) for (let t = 0; t < d; t++) Object.assign(e, c[t]);
        ...
        function O(e, t, r, n, i) {
          ...
          if (null === t)
            ...
            if (
              ...
              u.endEmitted ? _(e, new b()) : C(e, u, t, !0);
              ...
              (u.reading = !1),
                u.decoder && !r
                  ? ((t = u.decoder.write(t)),
                    u.objectMode || 0 !== t.length ? C(e, u, t, !1) : T(e, u))
                  : C(e, u, t, !1);
            }
          ...
          if (e._writev && r && r.next) {
            ...
            for (; r; ) {
              var u = r.chunk,
                ...
                d = r.callback;
              if (
                (O(e, t, !1, t.objectMode ? 1 : u.length, u, c, d),
                (r = r.next),
        ...
        r(609)(x, a),
          ...
          (x.prototype.write = function (e, t, r) {
            var n,
              ...
              i = !1,
              s = !o.objectMode && ((n = e), l.isBuffer(n) || n instanceof u);
            return (
              s &&
                !l.isBuffer(e) &&
                (e = (function (e) {
        ...
        e.exports = function (e) {
            ...
            r = Object.create(
              ...
              o(t, d, {
                value: function (e, t) {
                  var n = r[f].read();
                  n
                    ? ((r[c] = null), (r[s] = null), (r[a] = null), e(h(n, !1)))
                    : ((r[s] = e), (r[a] = t));
                },
                writable: !0,
              }),
          ...
          return (
            ...
            i(e, function (e) {
              ...
              var n = r[s];
              null !== n &&
                ((r[c] = null), (r[s] = null), (r[a] = null), n(h(void 0, !0))),
                (r[u] = !0);
            }),
        ...
        e.exports = function () {
          ...
          var s = t.map(function (e, r) {
            ...
            return l(e, i, r > 0, function (e) {
              n || (n = e), e && s.forEach(u), i || (s.forEach(u), o(n));
            });
          });
          return t.reduce(c);
        };
            ...
            switch (
              ...
              case "object": {
                ...
                if (Array.isArray(n)) {
                  ...
                  let a = 0;
                  for (; a < t - 1; a++) {
                    const e = u(a, n[a], s, l, c, d);
                    (r += void 0 !== e ? e : "null"), (r += f);
                  }
                  const h = u(a, n[a], s, l, c, d);
                  return (
                    (r += void 0 !== h ? h : "null"),
                    n.length - 1 > i &&
            ...
            switch (typeof s) {
              ...
              case "object": {
                ...
                if (Array.isArray(s)) {
                  ...
                  let a = 0;
                  for (; a < n - 1; a++) {
                    const r = g(a, s[a], u, f, h);
                    (e += void 0 !== r ? r : "null"), (e += t);
                  }
                  const l = g(a, s[a], u, f, h);
                  return (
                    (e += void 0 !== l ? l : "null"),
                    s.length - 1 > i &&
          ...
          function v(e, s, u) {
            switch (typeof s) {
              ...
              case "object": {
                if (null === s) return "null";
                if ("function" == typeof s.toJSON) {
                  if ("object" != typeof (s = s.toJSON(e))) return v(e, s, u);
                  if (null === s) return "null";
                }
                if (-1 !== u.indexOf(s)) return t;
                let r = "";
            ...
            if (arguments.length > 1) {
              ...
              if (
                ...
                if ("function" == typeof t)
                  return s("", { "": e }, [], t, n, "");
                if (Array.isArray(t)) return u("", e, [], m(t), n, "");
              }
      ...
      7891: (e, t) => {
        ...
        for (var Y = 0; Y < 35; Y++)
          r(Y, s[Y]),
            o[Y] || ((o[Y] = new RegExp(s[Y])), (i[Y] = new RegExp(u(s[Y]))));
        function V(e, t) {
          if (
            ((t && "object" == typeof t) ||
        ...
        function ce(e, t, r, n, o, i, s, a, l, u, c, d, f) {
          return (
            (t = ue(r)
              ? ""
              : ue(n)
        ...
        (se.prototype.parse = function (e) {
          var t = this.options.loose ? i[U] : i[B],
            r = e.match(t);
            ...
            if (
              ...
              n.__sourceMapSupport ||
                ((t.prototype._compile = function (e, t) {
                  return (c[t] = e), (d[t] = void 0), n.call(this, e, t);
                }),
      ...
      9888: (e, t) => {
        ...
        function n(e, t, o, i) {
          if (o < i) {
            ...
            r(
              e,
              ((c = o), (d = i), Math.round(c + Math.random() * (d - c))),
              i
            );
      ...
      5600: (e, t, r) => {
        ...
        (l.fromSourceMap = function (e) {
            ...
            for (
              ...
              if (";" === e.charAt(y)) d++, y++, (f = 0);
                ...
                if ((i = w[(o = e.slice(y, l))])) y += o.length;
                  ...
                  for (i = []; y < l; )
                    s.decode(e, y, b), (u = b.value), (y = b.rest), i.push(u);
                  if (2 === i.length)
          ...
          (u.prototype._findMapping = function (e, t, r, n, i, s) {
            if (e[r] <= 0)
              throw new TypeError(
            ...
            for (var r = 0; r < this._sections.length; r++)
              for (
                ...
                null !== o.consumer.sourceRoot &&
                  (u = n.join(o.consumer.sourceRoot, u)),
                  this._sources.add(u),
      ...
      4047: (e, t, r) => {
        ...
        (a.fromStringWithSourceMap = function (e, t, r) {
          ...
          return (
            ...
            l < s.length && (f && h(f, u()), n.add(s.splice(l).join(""))),
              ...
              .map(function (e) {
                ...
                if (r) {
                  var n = null,
                    ...
                    l = "native" === r[5];
                  if (r[1]) {
                    var u = (i = r[1]).lastIndexOf(".");
                    if (("." == i[u - 1] && u--, u > 0)) {
                      (n = i.substr(0, u)), (o = i.substr(u + 1));
                      var c = n.indexOf(".Module");
                      c > 0 && ((i = i.substr(c + 1)), (n = n.substr(0, c)));
                    }
                    s = null;
                  }
                  o && ((s = n), (a = o)),
        ...
        e.exports = (e, t) => {
          ...
          return (
            ...
            n.open(e.file, "a+", "0644", (o, i) => {
              ...
              !(function o() {
                if (!l.destroyed)
                  return n.read(i, r, 0, r.length, c, (n, i) => {
                    if (n)
  ...
  (() => {
    ...
    var A = r(9764);
    const k = require("url"),
      T = ["renderer.js", "main.js"];
    function j(e) {
      if (!T.some((t) => e.endsWith(t))) return null;
        ...
        h.push({
          ...
          submenu: [
            ...
            },
            {
              ...
              accelerator: "Ctrl+H",
              click: fe(u ? "hide-stashed-changes" : "show-stashed-changes"),
            },
    ...
    function me(e) {
      return (t, r) => {
        ...
        if (e === ue.Reset) (n.zoomFactor = 1), U(n, "zoom-factor-changed", 1);
        else {
    ...
    const ke = t.resolve(process.execPath, ".."),
      Te = t.resolve(ke, ".."),
      je = t.resolve(t.join(Te, "Update.exe")),
    ...
    function Fe(e) {
      return Ie(["--createShortcut", Le, "-l", e.join(",")]);
    }
    function He(e) {
      return Ue(e)
        ? "x64-emulated"
    ...
    async function Ye() {
      if (!We) {
        let e = await (async function () {
          let e;
          try {
            (e = (await (0, g.readFile)(Ke(), "utf8")).trim()),
    ...
    async function Ve(e) {
      (We = e), await (0, g.writeFile)(Ke(), e, "utf8");
    }
    const Ke = () => (0, t.join)(o.app.getPath("userData"), ".guid");
    let Ze = !1;
    async function Je(e, t, r) {
      ...
      if (
        ...
        n.set("architecture", He(o.app)),
        n.set("sha", "a21e55b38e5b97ebffbc95c48e091bbd64937b01"),
    ...
    function tt() {
      ...
      return (e && e.submenu ? e.submenu.items : []).filter(
        (e) => !et(e.role, "pasteandmatchstyle")
      );
    }
    function rt(e, t, r) {
      const n = nt(e, t);
    ...
    function nt(e, t, r = []) {
      ...
      for (const [i, s] of e.entries())
        if (et(s.role, "editmenu")) for (const e of tt()) n.append(e);
        else {
          const e = [...r, i];
          n.append(
            new o.MenuItem({
              ...
              role: s.role,
              click: () => t(e),
              submenu: s.submenu ? nt(s.submenu, t, e) : void 0,
            })
          );
        }
      return n;
    ...
    class st {
      ...
      onSendHeaders;
      constructor(e) {
        (this.onBeforeRedirect = new ot(e.onBeforeRedirect.bind(e))),
          (this.onBeforeRequest = new it(
          ...
          (this.onBeforeSendHeaders = new it(
          ...
          (this.onCompleted = new ot(e.onCompleted.bind(e))),
          (this.onErrorOccurred = new ot(e.onErrorOccurred.bind(e))),
          (this.onHeadersReceived = new it(
          ...
          (this.onResponseStarted = new ot(e.onResponseStarted.bind(e))),
          (this.onSendHeaders = new ot(e.onSendHeaders.bind(e)));
      }
    }
    const at = (e) =>
    ...
    ct("select-all-window-contents", 0),
      ...
      ut("is-window-focused", 0),
      ct("focus-window", 0),
      ut("show-item-in-folder", 1),
      ct("unsafe-open-directory", 1),
      ut("open-external", 1),
      ut("move-to-trash", 1),
      ut("get-current-window-state", 0),
      ut("get-current-window-zoom-factor", 0),
      ct("set-window-zoom-factor", 1),
      ut("check-for-updates", 1),
      ct("quit-and-install-updates", 0),
      ct("quit-app", 0),
      ct("set-native-theme-source", 1),
      ut("should-use-dark-colors", 0),
      ct("minimize-window", 0),
      ct("maximize-window", 0),
      ct("unmaximize-window", 0),
      ct("close-window", 0),
      ut("is-window-maximized", 0),
      ut("get-apple-action-on-double-click", 0),
      ct("show-certificate-trust-dialog", 2),
      ut("get-path", 1),
      ut("get-app-architecture", 0),
      ut("get-app-path", 0),
      ut("is-running-under-arm64-translation", 0),
      ut("move-to-applications-folder", 0),
      ct("get-app-menu", 0),
      ut("show-contextual-menu", 2),
      ct("update-preferred-app-menu-item-labels", 1),
      ct("uncaught-exception", 1),
      ct("send-error-report", 3),
      ct("update-accounts", 1),
      ut("resolve-proxy", 1),
      ut("is-in-application-folder", 0),
      ut("show-save-dialog", 1),
      ut("show-open-dialog", 1),
      ut("save-guid", 1),
      ut("get-guid", 0),
      ut("show-notification", 3),
      ut("get-notifications-permission", 0),
      ut("request-notifications-permission", 0),
      ct("install-windows-cli", 0),
      ct("uninstall-windows-cli", 0),
      Error,
      ((ft = dt || (dt = {}))[(ft.Sms = 0)] = "Sms"),
      (ft[(ft.App = 1)] = "App"),
      r(4515);
    var ht = r(7891);
    const pt = new ht.SemVer("3.1.0"),
      mt = (new Map(), new Map()),
      gt = (e) => e === kt(),
      vt = (e) => new URL(e).hostname.endsWith(".ghe.com");
    function yt(e) {
      const t = `endpoint-version:${e}`,
        r = mt.get(t);
      if (void 0 !== r) return r;
      const n = localStorage.getItem(t),
        o = null === n ? null : ht.parse(n);
    ...
    const bt =
        ({ dotcom: e, ghe: t, es: r }, n = yt) =>
        (o) =>
          wt(e, gt(o)) ||
          wt(t ?? e, vt(o)) ||
          wt(r, ((e) => !gt(e) && !vt(e))(o), n(o) ?? pt),
      _t =
        (bt({ es: ">= 3.0.0" }),
        bt({ dotcom: !0, es: ">= 3.4.0" }),
        bt({ dotcom: !0 }),
        bt({ dotcom: !0 }),
        bt({ dotcom: !0 }),
        bt({ dotcom: !0 }),
    ...
    const Tt = "Set spellcheck to English",
      jt = "Set spellcheck to system language";
    ...
    function It(e) {
      ...
      Lt && (Lt.destroy(), (Lt = null)),
        (function (e, t) {
          if ((log.error(I(t)), Qe)) return;
          (Qe = !0),
            (function () {
              const e = o.Menu.getApplicationMenu();
              if (e) for (const t of e.items) ge(t);
            })();
          const r = new Xe(e ? "launch" : "generic", t);
          r.onDidLoad(() => {
            r.show();
          }),
          ...
          switch (e) {
            case "--squirrel-install":
              return (async function () {
                await Fe(["StartMenu", "Desktop"]), await Ne();
              })();
            case "--squirrel-updated":
              return (async function () {
                await (async function () {
                  ...
                  var r;
                  return Fe(["StartMenu", "Desktop"]);
                })(),
                  await Ne();
              })();
            case "--squirrel-uninstall":
              return (async function () {
                return await Ie(["--removeShortcut", Le]), Pe();
              })();
    ...
    (function (e) {
      ...
      o.app.on("ready", () => {
        ...
        (Dt = V() - Nt),
          Ut.forEach((e) =>
            (function (e) {
              o.app.setAsDefaultProtocolClient(e, process.execPath, [Ht]);
            })(e)
          ),
          (function () {
            const e = new ie();
        ...
        const e = new st(o.session.defaultSession.webRequest);
        !(function (e) {
          const t = new Map(),
        ...
        o.Menu.setApplicationMenu(
          ...
          Q("install-windows-cli", Ne),
          Q("uninstall-windows-cli", Pe),
          ...
          ee("get-app-architecture", async () => He(o.app)),
          ee("get-app-path", async () => o.app.getAppPath()),
          ee("is-running-under-arm64-translation", async () => Ue(o.app)),
