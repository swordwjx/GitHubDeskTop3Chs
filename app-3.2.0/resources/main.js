  ...
  (() => {
    ...
    function oe(e, t = "@", n = new Set()) {
      for (const r of e) {
        ...
        (r.id = i), n.add(i), r.submenu && oe(r.submenu, r.id, n);
      }
    }
    function se(e) {
    ...
    function de(e) {
      return (t, n) => {
        ...
        if (e === ae.Reset) (r.zoomFactor = 1), F(r, "zoom-factor-changed", 1);
        else {
    ...
    function pe(e) {
      ...
      if (e.submenu instanceof i.Menu)
        for (const n of e.submenu.items) pe(n) && (t = !0);
    ...
    const me = require("child_process");
    ...
    async function Ee(e) {
      ...
      await xe(n, ["Path", e.join(";")]);
    }
    function xe(e, t) {
      try {
        const n = (0, me.spawn)(e, t);
    ...
    const Oe = t.resolve(process.execPath, ".."),
      Ce = t.resolve(Oe, ".."),
      Re = t.resolve(t.join(Ce, "Update.exe")),
      Me = t.basename(process.execPath);
    async function Ae() {
      const e = ke();
    ...
    function Te(e) {
      return je(["--createShortcut", Me, "-l", e.join(",")]);
    }
    function Ne(e) {
      return De(e)
        ? "x64-emulated"
    ...
    async function Be() {
      if (!Ue) {
        let e = await (async function () {
          let e;
          try {
            (e = (await (0, g.readFile)(ze(), "utf8")).trim()),
    ...
    async function He(e) {
      (Ue = e), await (0, g.writeFile)(ze(), e, "utf8");
    }
    const ze = () => (0, t.join)(i.app.getPath("userData"), ".guid");
    let qe = !1;
    async function We(e, t, n) {
      ...
      if (
        ...
        r.set("architecture", Ne(i.app)),
        r.set("sha", "3a1561b01c219f95f5acb7d91c62af30851e541d"),
    ...
    function Je(e, t, n = []) {
      ...
      for (const [o, s] of e.entries())
        if (Ve(s.role, "editmenu")) for (const e of Ke()) r.append(e);
        else {
          const e = [...n, o];
          r.append(
            new i.MenuItem({
              ...
              role: s.role,
              click: () => t(e),
              submenu: s.submenu ? Je(s.submenu, t, e) : void 0,
            })
          );
        }
      return r;
    ...
    class et {
      ...
      onSendHeaders;
      constructor(e) {
        (this.onBeforeRedirect = new Xe(e.onBeforeRedirect.bind(e))),
          ...
          (this.onCompleted = new Xe(e.onCompleted.bind(e))),
          (this.onErrorOccurred = new Xe(e.onErrorOccurred.bind(e))),
          ...
          (this.onResponseStarted = new Xe(e.onResponseStarted.bind(e))),
          (this.onSendHeaders = new Xe(e.onSendHeaders.bind(e)));
      }
    }
    const tt = (e) =>
    ...
    const rt = "Set spellcheck to English",
      it = "Set spellcheck to system language";
    ...
    function ct(e) {
      ...
      ot && (ot.destroy(), (ot = null)),
        (function (e, t) {
          ...
          const n = new Ge(e ? "launch" : "generic", t);
          n.onDidLoad(() => {
            n.show();
          }),
    ...
    function ft() {
      return {
        uptime: ((G() - st) / 1e3).toFixed(3),
        time: new Date().toString(),
      };
    }
    const ht = "--protocol-launcher",
      dt = new Set(["x-github-client"]);
    dt.add("x-github-desktop-auth"),
      dt.add("github-windows"),
          ...
          switch (e) {
            case "--squirrel-install":
              return (async function () {
                await Te(["StartMenu", "Desktop"]), await Ae();
              })();
    ...
    if (!pt) {
      ...
      (mt = !e),
        i.app.on("second-instance", (e, t, n) => {
          ot &&
            (ot.isMinimized() && ot.restore(),
            ot.isVisible() || ot.show(),
            ot.focus()),
            vt(t);
        }),
        mt && i.app.quit();
    ...
    (function (e) {
      ...
      i.app.on("ready", () => {
        ...
        (ut = G() - st),
          dt.forEach((e) =>
            (function (e) {
              i.app.setAsDefaultProtocolClient(e, process.execPath, [ht]);
            })(e)
          ),
          (function () {
            const e = new re();
            e.onClosed(() => {
              (ot = null), at || i.app.quit();
            }),
              e.onDidLoad(() => {
                e.show(),
        ...
        i.Menu.setApplicationMenu(
          ...
          J("update-preferred-app-menu-item-labels", (e, t) => {
            ...
            o && ot && (i.Menu.setApplicationMenu(n), ot.sendAppMenu());
          }),
          ...
          J("update-menu-state", (e, t) => {
            ...
            if (null !== r) {
              ...
              n && ot && (i.Menu.setApplicationMenu(r), ot.sendAppMenu());
          ...
          X("check-for-updates", async (e, t) => ot?.checkForUpdates(t)),
          J("quit-and-install-updates", () => ot?.quitAndInstallUpdate()),
          J("quit-app", () => i.app.quit()),
          J("minimize-window", () => ot?.minimizeWindow()),
          J("maximize-window", () => ot?.maximizeWindow()),
          J("unmaximize-window", () => ot?.unmaximizeWindow()),
          J("close-window", () => ot?.closeWindow()),
          X("is-window-maximized", async () => ot?.isMaximized() ?? !1),
          ...
          X("get-current-window-state", async () =>
            ot?.getCurrentWindowState()
          ),
          X("get-current-window-zoom-factor", async () =>
            ot?.getCurrentWindowZoomFactor()
          ),
          J("set-window-zoom-factor", (e, t) => ot?.setWindowZoomFactor(t)),
          J("get-app-menu", () => ot?.sendAppMenu()),
          ...
          X("get-app-architecture", async () => Ne(i.app)),
          ...
          J("select-all-window-contents", () => ot?.selectAllWindowContents()),
          X(
          ...
          X("show-save-dialog", async (e, t) => ot?.showSaveDialog(t) ?? null),
          X("show-open-dialog", async (e, t) => ot?.showOpenDialog(t) ?? null),
          X("is-window-focused", async () => ot?.isFocused() ?? !1),
          J("focus-window", () => {
            ot?.focus();
          }),
