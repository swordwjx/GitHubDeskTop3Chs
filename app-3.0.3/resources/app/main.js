...
(() => {
	...
	(() => {
		...
		async function He(e, t, n) {
			...
			const r = new Map;
			if (r.set("name", e.name), r.set("message", e.message), e.stack && r.set("stack", e.stack), r.set("platform", "win32"), r.set("architecture", Le(i.app)), r.set("sha", "ecd0e10953dba5193595453ac727c4fcc679c366"), r.set("version", i.app.getVersion()), r.set("guid", await $e()), t)
		...
		ct.add("x-github-desktop-auth"), ct.add("github-windows"), i.app.on("window-all-closed", (() => {})), process.on("uncaughtException", (e => {
			He(e = N(e), ut()), at(e)
		}));
		let ft = !1;
		...
		if (!ft) {
			...
			dt = !e, i.app.on("second-instance", ((e, t, n) => {
				nt && (nt.isMinimized() && nt.restore(), nt.isVisible() || nt.show(), nt.focus()), pt(t)
			})), dt && i.app.quit()
		}
		...
		function pt(e) {
			log.info(`Received possible protocol arguments: ${e.length}`); {
				...
				e.includes(lt) && 1 === t.length ? ht(t[0]) : log.error(`Malformed launch arguments received: ${e}`)
			}
		}
		...
		function gt(e) {
			...
			if (dt || ft) return;
			ot = G() - rt, ct.forEach((e => function(e) {
			...
			i.Menu.setApplicationMenu(oe({
				...
				if (null === r) return i.Menu.setApplicationMenu(n), void(null !== nt && nt.sendAppMenu());
				let o = !1;
				for (const e of he(n)) {
					const t = e.id;
					if (!t) continue;
							...
							e.webContents.once("context-menu", ((n, r) => t(function(e, t, n) {
								...
								r && s.push(new i.MenuItem({
									...
									const {
										...
										const r = "en-US";
										if (e === r && t.includes(r) || !n.includes(e)) return null;
										const i = t.includes(r) && !t.includes(e) ? e : r;
										return {
											label: i === r ? et : tt,
											languages: [i]
										}
									}(i.app.getLocale(), e.getSpellCheckerLanguages(), e.availableSpellCheckerLanguages);
									null !== t && s.push(new i.MenuItem({
										label: t.label,
			...
			})))), Z("check-for-updates", (async (e, t) => nt?.checkForUpdates(t))), V("quit-and-install-updates", (() => nt?.quitAndInstallUpdate())), V("minimize-window", (() => nt?.minimizeWindow())), V("maximize-window", (() => nt?.maximizeWindow())), V("unmaximize-window", (() => nt?.unmaximizeWindow())), V("close-window", (() => nt?.closeWindow())), Z("is-window-maximized", (async () => nt?.isMaximized() ?? !1)), Z("get-apple-action-on-double-click", (async () => i.systemPreferences.getUserDefault("AppleActionOnDoubleClick", "string"))), Z("get-current-window-state", (async () => nt?.getCurrentWindowState())), Z("get-current-window-zoom-factor", (async () => nt?.getCurrentWindowZoomFactor())), V("set-window-zoom-factor", ((e, t) => nt?.setWindowZoomFactor(t))), V("get-app-menu", (() => nt?.sendAppMenu())), V("show-certificate-trust-dialog", ((e, t, n) => {
				gt((e => {
					e.showCertificateTrustDialog(t, n)
				}))
			})), V("log", ((e, t, n) => C(t, n))), V("uncaught-exception", ((e, t) => at(t))), V("send-error-report", ((e, t, n, r) => {
				He(t, {
					...ut(),
					...n
				}, r)
			...
			})), Z("move-to-trash", ((e, t) => i.shell.trashItem(t))), Z("show-item-in-folder", (async (e, t) => i.shell.showItemInFolder(t))), V("unsafe-open-directory", (async (e, t) => re(t))), V("select-all-window-contents", (() => nt?.selectAllWindowContents())), Z("is-in-application-folder", (async () => i.app.isInApplicationsFolder?.() ?? null)), Z("resolve-proxy", (async (e, t) => i.session.defaultSession.resolveProxy(t))), Z("show-save-dialog", (async (e, t) => nt?.showSaveDialog(t) ?? null)), Z("show-open-dialog", (async (e, t) => nt?.showOpenDialog(t) ?? null)), Z("is-window-focused", (async () => nt?.isFocused() ?? !1)), V("focus-window", (() => {
				nt?.focus()
